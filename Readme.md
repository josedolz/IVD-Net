...
Repository containing the source code of the IVD-Net segmentation network ([https://arxiv.org/abs/1811.08305])(https://arxiv.org/abs/1811.08305) that we proposed for the MICCAI 2018 IVD segmentation challenge. This architecture was used to segment the inetervertebral disc in multi-modal MRI images. Nevertheless, it can be used to segment any other structure/s in a multi-modal image setting.
